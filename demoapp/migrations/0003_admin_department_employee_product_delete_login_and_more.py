...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='Department',
            fields=[
                ('id', models.PositiveIntegerField(primary_key=True, serialize=False, verbose_name='Item Id')),
                ('name', models.CharField(max_length=100, unique=True, verbose_name='Item Name')),
                ('location', models.CharField(max_length=100, verbose_name='Item Quantity')),
            ],
            options={
