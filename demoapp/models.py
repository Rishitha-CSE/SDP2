...
class Department(models.Model):
    id=models.PositiveIntegerField(primary_key=True,verbose_name="Item Id")
    name=models.CharField(max_length=100,blank=False,unique=True,verbose_name="Item Name")
    location = models.CharField(max_length=100, blank=False,verbose_name="Item Quantity")
